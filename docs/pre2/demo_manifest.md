...
- **Recovered + shadow-verified**: idx 0,1,2,3,8,9,10,11 (`pre2/recovered/object_update.py`).
- **Witnessed but not yet recovered**: idx4 (`7ADF` orbit, demos 001416/001424/111734/112253/112428), idx6
  (`78EC`, earthquake), idx7 (`7898`, L5 111734), idx12 (`75C4`, earthquake/L7).
