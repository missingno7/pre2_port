...
| `bonus_pickup_scan` | `1030:899E` | **RECOVERED, shadow byte-exact** (150 calls/4 demos 0 mismatch). Live-hook PENDING the on-screen tile re-blit render integration (453B decode + 3B77). |
