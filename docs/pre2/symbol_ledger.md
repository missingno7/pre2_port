...
| combat/pickup interaction `88D7` | `1030:88D7` (orchestrator) | **MAPPED (Stage 0)** — `docs/pre2/combat_interaction_island.md`. Player + thrown-weapon (`0x4F2E`) vs enemies (`8C21`, damage/kill) + bonus tiles (`899E`, pickup/score). Leaves: `pack_spawn_pos` (8BF6) VERIFIED, `roll_bonus_sprite_id` (8C13) ASM_MATCHED (`recovered/combat_interaction.py`). Keystone TODO = `8D7B` sprite-hitbox proximity (tables `0x7190/0x7191/0x752A`). Witnesses: kills 115215/140619, pickups 105310/120536; `8B6E` tile-rewrite unwitnessed. |
