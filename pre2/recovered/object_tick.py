...
from pre2.recovered.object_update import (ObjectScaleUnsupported, advance_animation, apply_velocity,
                                          ...
                                          handle_object_78ec, handle_object_7adf, handle_object_7b91,
                                          handle_object_7c2d, handle_object_7c8c, handle_object_7c90,
                                          terrain_collision)
...
# handler-address (cs:[idx*2 + 0x6AA9]) -> recovered AI handler. All 12 witnessed types.
HANDLERS = {0x7C90: handle_object_7c90, 0x7C8C: handle_object_7c8c, 0x7C2D: handle_object_7c2d,
            0x7B91: handle_object_7b91, 0x7ADF: handle_object_7adf, 0x7898: handle_object_7898,
            0x78EC: handle_object_78ec, 0x77DE: handle_object_77de, 0x773D: handle_object_773d,
            0x7665: handle_object_7665, 0x760F: handle_object_760f, 0x75C4: handle_object_75c4}
