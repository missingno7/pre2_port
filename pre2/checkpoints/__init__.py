...
from . import animation, audio, blit, camera_shake, effects_update, fireflies, foreground_tiles, frame, gameover_scroll, hud, object_inject, object_interaction, object_particles, object_render, object_spawn, object_tick, object_update, oldies_text, palette, particles, player, player_collision, player_interaction, present, sprite_classify, sprite_decode, sqz, tally_panel, terrain_entities, text, tracker, transition  # noqa: F401 — import to register @registry.replace hooks
